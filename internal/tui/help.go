...
var helpKeys = []helpEntry{
	...
	{"Pin wizard", "left/right", "(form) cycle a field's value, or move the caret within the threads field"},
	...
	{"Pin wizard", "enter", "(manual) write the selection into the form's threads field"},
