...
var helpKeys = []helpEntry{
	...
	{"Pin wizard", "up/down / j k", "move between the node/within/threads/memory node/core-grid fields; wraps between the grid's top/bottom row and the neighboring field"},
